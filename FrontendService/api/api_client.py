...
# API Configuration
# VIGTIGT: brug samme navn som i docker-compose "container_name" eller "service name".
# I jeres compose er gateway service "gateway" men container_name er "api_gateway".
# I interne docker netværk virker service name mest stabilt: "gateway".
...
def _auth_headers() -> Dict[str, str]:
    """
    Laver Authorization header, hvis vi har en JWT i session_state.
    """
