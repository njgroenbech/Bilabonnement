...
def add_car(brand, model, year, license_plate, km_driven, fuel_type, status, location, purchase_price, sub_type, sub_price_per_month):
    conn = get_connection()
    cursor = conn.cursor(dictionary=True)

    cursor.execute("INSERT INTO cars (brand, model, year, license_plate, km_driven, fuel_type, status, location, purchase_price, sub_type, sub_price_per_month) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                   (brand, model, year, license_plate, km_driven, fuel_type, status, location, purchase_price, sub_type, sub_price_per_month))
